...
(cl:defmethod cl:initialize-instance :after ((m <DetectedPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ferns_ros-msg:<DetectedPoint> is deprecated: use ferns_ros-msg:DetectedPoint instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <DetectedPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ferns_ros-msg:x-val is deprecated.  Use ferns_ros-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <DetectedPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ferns_ros-msg:y-val is deprecated.  Use ferns_ros-msg:y instead.")
  (y m))
