...
(cl:defclass <Detection> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (top_left
    :reader top_left
    :initarg :top_left
    :type ferns_ros-msg:DetectedPoint
    :initform (cl:make-instance 'ferns_ros-msg:DetectedPoint))
   (top_right
    :reader top_right
    :initarg :top_right
    :type ferns_ros-msg:DetectedPoint
...
(cl:defmethod cl:initialize-instance :after ((m <Detection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Detection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ferns_ros-msg:<Detection> is deprecated: use ferns_ros-msg:Detection instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ferns_ros-msg:header-val is deprecated.  Use ferns_ros-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'model-val :lambda-list '(m))
(cl:defmethod model-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ferns_ros-msg:model-val is deprecated.  Use ferns_ros-msg:model instead.")
  (model m))

(cl:ensure-generic-function 'top_left-val :lambda-list '(m))
(cl:defmethod top_left-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ferns_ros-msg:top_left-val is deprecated.  Use ferns_ros-msg:top_left instead.")
  (top_left m))

(cl:ensure-generic-function 'top_right-val :lambda-list '(m))
(cl:defmethod top_right-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ferns_ros-msg:top_right-val is deprecated.  Use ferns_ros-msg:top_right instead.")
  (top_right m))

(cl:ensure-generic-function 'bottom_right-val :lambda-list '(m))
(cl:defmethod bottom_right-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ferns_ros-msg:bottom_right-val is deprecated.  Use ferns_ros-msg:bottom_right instead.")
  (bottom_right m))

(cl:ensure-generic-function 'bottom_left-val :lambda-list '(m))
(cl:defmethod bottom_left-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ferns_ros-msg:bottom_left-val is deprecated.  Use ferns_ros-msg:bottom_left instead.")
  (bottom_left m))
